 ...
 *  Rim Sound
 *
 *  Created by Carl Schissler on 8/8/12.
 *  Copyright 2012 __MyCompanyName__. All rights reserved.
 *
 */

#ifndef INCLUDE_RIM_SOUND_EXPANDER_H
#define INCLUDE_RIM_SOUND_EXPANDER_H
...
//********************************************************************************
//********************************************************************************
/// A class which reduces the level of sound which is below a certain threshold.
/**
	...
	public:
		...
		//******	Hold Accessor Methods
			...
			/**
			  ...
			  */
			RIM_INLINE Float getHold() const
			{
				return hold;
			}
			...
			/**
			  ...
			  */
			RIM_INLINE void setHold( Float newHold )
			{
				lockMutex();
	...
	private:
		...
		//******	Private Filter Processing Methods
			...
			/**
			  ...
			  */
			RIM_INLINE void expandNoChanges( const SoundBuffer& inputBuffer, SoundBuffer& outputBuffer, Size numSamples,
			...
			/**
			  ...
			  */
			RIM_INLINE void expand( const SoundBuffer& inputBuffer, SoundBuffer& outputBuffer, Size numSamples,
									Gain envelopeAttack, Gain envelopeRelease,
...
#endif // INCLUDE_RIM_SOUND_EXPANDER_H
