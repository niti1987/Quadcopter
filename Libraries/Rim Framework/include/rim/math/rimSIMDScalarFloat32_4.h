...
class RIM_ALIGN(16) SIMDScalar<Float32,4>
{
	...
	public:
		...
		//******	Comparison Operators
			...
			/**
			  ...
			  */
			RIM_FORCE_INLINE SIMDScalar<Int32,4> operator == ( const SIMDScalar& scalar ) const
			{
#if RIM_USE_SIMD && defined(RIM_SIMD_ALTIVEC)
				return SIMDScalar<Int32,4>( vec_cmpeq( v, scalar.v ) );
#elif RIM_USE_SIMD && defined(RIM_SIMD_SSE) && RIM_SSE_VERSION_IS_SUPPORTED(1,0)
				return SIMDScalar<Int32,4>( _mm_cmpeq_ps( v, scalar.v ) );
#else
			...
			/**
			  ...
			  * component is non-zero. Otherwise, that result component is equal to zero.
			  */
			RIM_FORCE_INLINE SIMDScalar<Int32,4> operator == ( const Float32 value ) const
			{
#if RIM_USE_SIMD && defined(RIM_SIMD_ALTIVEC)
				return SIMDScalar<Int32,4>( vec_cmpeq( v, (SIMDScalar4)(value) ) );
#elif RIM_USE_SIMD && defined(RIM_SIMD_SSE) && RIM_SSE_VERSION_IS_SUPPORTED(1,0)
				return SIMDScalar<Int32,4>( _mm_cmpeq_ps( v, _mm_set1_ps( value ) ) );
#else
...
#elif RIM_USE_SIMD && defined(RIM_SIMD_SSE) && RIM_SSE_VERSION_IS_SUPPORTED(1,0)
				return SIMDScalar<Int32,4>( _mm_cmpneq_ps( v, scalar.v ) );
#else
				return SIMDScalar<Int32,4>( a != scalar.a, b != scalar.b, c != scalar.c, d != scalar.d );
#endif
			}
			...
			RIM_FORCE_INLINE SIMDScalar<Int32,4> operator != ( const Float32 value ) const
			{
				...
				return SIMDScalar<Int32,4>( vec_nor( temp, temp ) );
#elif RIM_USE_SIMD && defined(RIM_SIMD_SSE) && RIM_SSE_VERSION_IS_SUPPORTED(1,0)
				return SIMDScalar<Int32,4>( _mm_cmpneq_ps( v, _mm_set1_ps( value ) ) );
#else
				return SIMDScalar<Int32,4>( a != value, b != value, c != value, d != value );
#endif
			}
			...
			{
#if RIM_USE_SIMD && defined(RIM_SIMD_ALTIVEC)
				return SIMDScalar<Int32,4>( vec_cmplt( v, scalar.v ) );
#elif RIM_USE_SIMD && defined(RIM_SIMD_SSE) && RIM_SSE_VERSION_IS_SUPPORTED(1,0)
				return SIMDScalar<Int32,4>( _mm_cmplt_ps( v, scalar.v ) );
#else
				return SIMDScalar<Int32,4>( a < scalar.a, b < scalar.b, c < scalar.c, d < scalar.d );
#endif
			}
			...
			{
#if RIM_USE_SIMD && defined(RIM_SIMD_ALTIVEC)
				return SIMDScalar<Int32,4>( vec_cmplt( v, (SIMDScalar4)(value) ) );
#elif RIM_USE_SIMD && defined(RIM_SIMD_SSE) && RIM_SSE_VERSION_IS_SUPPORTED(1,0)
				return SIMDScalar<Int32,4>( _mm_cmplt_ps( v, _mm_set1_ps( value ) ) );
#else
				return SIMDScalar<Int32,4>( a < value, b < value, c < value, d < value );
#endif
			}
			...
			{
#if RIM_USE_SIMD && defined(RIM_SIMD_ALTIVEC)
				return SIMDScalar<Int32,4>( vec_cmpgt( v, scalar.v ) );
#elif RIM_USE_SIMD && defined(RIM_SIMD_SSE) && RIM_SSE_VERSION_IS_SUPPORTED(1,0)
				return SIMDScalar<Int32,4>( _mm_cmpgt_ps( v, scalar.v ) );
#else
				return SIMDScalar<Int32,4>( a > scalar.a, b > scalar.b, c > scalar.c, d > scalar.d );
#endif
			}
			...
			{
#if RIM_USE_SIMD && defined(RIM_SIMD_ALTIVEC)
				return SIMDScalar<Int32,4>( vec_cmpgt( v, (SIMDScalar4)(value) ) );
#elif RIM_USE_SIMD && defined(RIM_SIMD_SSE) && RIM_SSE_VERSION_IS_SUPPORTED(1,0)
				return SIMDScalar<Int32,4>( _mm_cmpgt_ps( v, _mm_set1_ps( value ) ) );
#else
				return SIMDScalar<Int32,4>( a > value, b > value, c > value, d > value );
#endif
			}
			...
			{
#if RIM_USE_SIMD && defined(RIM_SIMD_ALTIVEC)
				return SIMDScalar<Int32,4>( vec_cmple( v, scalar.v ) );
#elif RIM_USE_SIMD && defined(RIM_SIMD_SSE) && RIM_SSE_VERSION_IS_SUPPORTED(1,0)
				return SIMDScalar<Int32,4>( _mm_cmple_ps( v, scalar.v ) );
#else
				return SIMDScalar<Int32,4>( a <= scalar.a, b <= scalar.b, c <= scalar.c, d <= scalar.d );
#endif
			}
			...
			{
#if RIM_USE_SIMD && defined(RIM_SIMD_ALTIVEC)
				return SIMDScalar<Int32,4>( vec_cmple( v, (SIMDScalar4)(value) ) );
#elif RIM_USE_SIMD && defined(RIM_SIMD_SSE) && RIM_SSE_VERSION_IS_SUPPORTED(1,0)
				return SIMDScalar<Int32,4>( _mm_cmple_ps( v, _mm_set1_ps( value ) ) );
#else
				return SIMDScalar<Int32,4>( a <= value, b <= value, c <= value, d <= value );
#endif
			}
			...
			{
#if RIM_USE_SIMD && defined(RIM_SIMD_ALTIVEC)
				return SIMDScalar<Int32,4>( vec_cmpge( v, scalar.v ) );
#elif RIM_USE_SIMD && defined(RIM_SIMD_SSE) && RIM_SSE_VERSION_IS_SUPPORTED(1,0)
				return SIMDScalar<Int32,4>( _mm_cmpge_ps( v, scalar.v ) );
#else
				return SIMDScalar<Int32,4>( a >= scalar.a, b >= scalar.b, c >= scalar.c, d >= scalar.d );
#endif
			}
			...
			{
#if RIM_USE_SIMD && defined(RIM_SIMD_ALTIVEC)
				return SIMDScalar<Int32,4>( vec_cmpge( v, (SIMDScalar4)(value) ) );
#elif RIM_USE_SIMD && defined(RIM_SIMD_SSE) && RIM_SSE_VERSION_IS_SUPPORTED(1,0)
				return SIMDScalar<Int32,4>( _mm_cmpge_ps( v, _mm_set1_ps( value ) ) );
#else
				return SIMDScalar<Int32,4>( a >= value, b >= value, c >= value, d >= value );
#endif
			}
		...
		//******	Required Alignment Accessor Methods
			...
			RIM_FORCE_INLINE static Bool isSupported()
			{
				...
				return (flags & SIMDFlags::SSE) != 0 || (flags & SIMDFlags::ALTIVEC) != 0;
			}
	...
	private:
		...
		//******	Private Friend Declarations
			...
			friend RIM_FORCE_INLINE SIMDScalar<Float32,4> select( const SIMDScalar<Int32,4>& selector,
...
RIM_FORCE_INLINE SIMDScalar<Float32,4> select( const SIMDScalar<Int32,4>& selector,
												const SIMDScalar<Float32,4>& scalar1, const SIMDScalar<Float32,4>& scalar2 )
{
#if RIM_USE_SIMD && defined(RIM_SIMD_ALTIVEC)
