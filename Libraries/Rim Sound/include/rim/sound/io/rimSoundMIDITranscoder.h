...
#ifndef INCLUDE_RIM_SOUND_MIDI_TRANSCODER_H
#define INCLUDE_RIM_SOUND_MIDI_TRANSCODER_H
...
class MIDITranscoder : public ResourceTranscoder<MIDIBuffer>
{
	public:
		...
		//******	Encoding Methods
			...
			virtual Bool canEncode( const MIDIBuffer& midi ) const;
			...
			/**
			  ...
			  */
			virtual Bool encode( const ResourceID& identifier, const MIDIBuffer& midi );
		...
		//******	Decoding Methods
			...
			/**
			  ...
			  */
			virtual Pointer<MIDIBuffer> decode( const ResourceID& identifier, ResourceManager* manager = NULL );
...
#endif // INCLUDE_RIM_SOUND_MIDI_TRANSCODER_H
