/*
 *  rimSoundSampleRateConverter.h
 *  Rim Sound
 *
 *  Created by Carl Schissler on 7/22/12.
 *  Copyright 2012 __MyCompanyName__. All rights reserved.
 *
 */

#ifndef INCLUDE_RIM_SOUND_SAMPLE_RATE_CONVERTER_H
#define INCLUDE_RIM_SOUND_SAMPLE_RATE_CONVERTER_H
...
//********************************************************************************
//********************************************************************************
/// A class which converts samples from an input buffer to a set output sample rate.
/**
  ...
  */
class SampleRateConverter : public SoundFilter
{
	public:
		...
		//******	Constructors
			...
			SampleRateConverter( Type newConversionType );
			
			
			
			
			/// Create a sample rate converter with the specified conversion type and output sample rate.
			SampleRateConverter( Type newConversionType, SampleRate newOutputSampleRate );
			
			
			
			
			/// Create an exact copy of the specified sample rate converter.
			SampleRateConverter( const SampleRateConverter& other );
		...
		//******	Assignment Operator
			...
			SampleRateConverter& operator = ( const SampleRateConverter& other );
		...
		//******	Destination Sample Rate Accessor Methods
			...
			/**
			  ...
			  */
			RIM_INLINE void setOutputSampleRate( SampleRate newOutputSampleRate )
			{
				lockMutex();
		...
		//******	Destination Sample Rate Accessor Methods
			...
			/**
			  ...
			  * use based on the application.
			  */
			RIM_INLINE void setType( Type newSampleRateConversionType )
			{
				lockMutex();
		...
		//******	Filter Attribute Accessor Methods
			...
			/**
			  * This method returns the value SoundFilterCategory::UTILITY.
			  */
	...
	private:
		...
		//******	Private Data Members
			...
			/// A cutoff filter, optionally NULL, which is used to antialias the converted audio.
...
#endif // INCLUDE_RIM_SOUND_SAMPLE_RATE_CONVERTER_H
