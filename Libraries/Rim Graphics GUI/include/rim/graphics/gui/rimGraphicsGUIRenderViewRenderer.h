/*
 *  rimGraphicsGUIRenderViewRenderer.h
 *  Rim Graphics GUI
 *
...
#ifndef INCLUDE_RIM_GRAPHICS_GUI_RENDER_VIEW_RENDERER_H
#define INCLUDE_RIM_GRAPHICS_GUI_RENDER_VIEW_RENDERER_H
...
//********************************************************************************
//********************************************************************************
/// A class which handles drawing RenderView objects to a graphics rendering context.
template <>
class GUIObjectRenderer<RenderView>
{
	public:
		...
		//******	Object Rendering Methods
			...
			/**
			  ...
			  */
			virtual Bool render( GUIRenderer& renderer, const AABB2f& parentBounds, const RenderView& contentView ) const = 0;
		...
		//******	Background Color Accessor Methods
			...
			/**
			  * The method returns whether or not the render view's background color was successfully changed.
			  */
		...
		//******	Border Color Accessor Methods
			...
			/**
			  * The method returns whether or not the render view border color was successfully changed.
			  */
...
/// A short name for the interface of a class that draws a RenderView.
typedef GUIObjectRenderer<RenderView> RenderViewRenderer;
...
#endif // INCLUDE_RIM_GRAPHICS_GUI_RENDER_VIEW_RENDERER_H
