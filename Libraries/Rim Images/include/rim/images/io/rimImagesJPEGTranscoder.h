...
#ifndef INCLUDE_RIM_IMAGES_JPEG_TRANSCODER_H
#define INCLUDE_RIM_IMAGES_JPEG_TRANSCODER_H
...
//********************************************************************************
//********************************************************************************
/// A class which handles encoding and decoding image data to/from the jpeg format (.jpg)
class JPEGTranscoder : public ImageTranscoder
{
	public:
...
#endif // INCLUDE_RIM_IMAGES_JPEG_TRANSCODER_H
