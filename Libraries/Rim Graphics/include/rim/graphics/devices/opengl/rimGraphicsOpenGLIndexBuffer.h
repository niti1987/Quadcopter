/*
 *  rimGraphicsOpenGLIndexBuffer.h
 *  Rim Graphics
 *
...
#ifndef INCLUDE_RIM_GRAPHICS_OPENGL_INDEX_BUFFER_H
#define INCLUDE_RIM_GRAPHICS_OPENGL_INDEX_BUFFER_H
...
//********************************************************************************
//********************************************************************************
/// A class which represents a buffer of indices stored in GPU memory.
class OpenGLIndexBuffer : public IndexBuffer
{
	public:
		...
		//******	Destructors
			...
			/// Destroy this index buffer and all state associated with it.
			~OpenGLIndexBuffer();
		...
		//******	Attribute Accessor Methods
			...
			/// Read the specified number of attributes from the index buffer into the specified output pointer.
			virtual Bool getAttributes( void* attributes, Size& numAttributes ) const;
			
			
			
			
			/// Replace the contents of this index buffer with the specified attributes.
		...
		//******	Integral Identifier Accessor Method
			...
			/// Get a unique integral identifier for this index buffer.
	...
	private:
		...
		//******	Private Constructors
			...
			/// Create an empty index buffer with the given usage type.
			OpenGLIndexBuffer( const GraphicsContext* context, const HardwareBufferUsage& usageType );
			
			
			
			
			/// Create an empty index buffer with the given usage type, attribute type, and capacity.
			OpenGLIndexBuffer( const GraphicsContext* context, const AttributeType& attributeType,
								Size capacity, const HardwareBufferUsage& usageType );
			
			
			
			
			/// Create an empty index buffer with the type, attributes, and usage type.
			OpenGLIndexBuffer( const GraphicsContext* context, const void* attributes,
								const AttributeType& attributeType, Size capacity,
								const HardwareBufferUsage& usageType );
		...
		//******	Private Data Members
			...
			/// The ID used by OpenGL to uniquely identify this index buffer.
			OpenGLID bufferID;
...
#endif // INCLUDE_RIM_GRAPHICS_OPENGL_INDEX_BUFFER_H
