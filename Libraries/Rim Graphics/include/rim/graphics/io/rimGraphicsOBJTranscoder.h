		...
		//******	Private Class Declaration
			...
			class OBJMaterial
			{
				public:
					...
					StaticArray<Float,8> soundR;
					StaticArray<Float,8> soundS;
					StaticArray<Float,8> soundT;
			...
			typedef enum MTLKeywordType
			{
				...
				/// 'sound_r' Sound material reflectivity.
				SOUND_R,
				
				/// 'sound_s' Sound material scattering.
				SOUND_S,
				
				/// 'sound_t' Sound material transmission.
				SOUND_T
			};
