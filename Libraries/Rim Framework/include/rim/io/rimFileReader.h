...
#ifndef INCLUDE_RIM_FILE_READER_H
#define INCLUDE_RIM_FILE_READER_H
...
#include "rimDataInputStream.h"
#include "rimStringInputStream.h"
...
class FileReader : public DataInputStream, public StringInputStream
{
	public:
		...
		//******	Constructors
			...
			/// Create a FileReader object which should read from the file at the specified path string.
			...
			/// Create a FileReader object which should read from the file at the specified path.
			FileReader( const fs::Path& filePath );
			
			
			
			
			/// Create a FileReader object which should read from the specified file.
		...
		//******	File Reader Open/Close Methods
			...
			/**
			  ...
			  * the reader is closed. If the file is unable to be closed, an IOException is
			  * thrown. If the file reader is already closed when the method is called,
...
#endif // INCLUDE_RIM_FILE_READER_H
