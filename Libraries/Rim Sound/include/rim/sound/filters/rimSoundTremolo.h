 ...
 *  Rim Sound
 *
 *  Created by Carl Schissler on 8/23/12.
 *  Copyright 2012 __MyCompanyName__. All rights reserved.
 *
 */

#ifndef INCLUDE_RIM_SOUND_TREMOLO_H
#define INCLUDE_RIM_SOUND_TREMOLO_H
...
class Tremolo : public SoundFilter
{
	public:
		...
		//******	Wave Type Accessor Methods
			...
			/**
			  ...
			  */
			RIM_INLINE WaveType getType() const
			{
				return type;
			}
			...
			/**
			  ...
			  */
			RIM_INLINE void setType( WaveType newType )
			{
				lockMutex();
				type = newType;
				unlockMutex();
		...
		//******	Tremolo Depth Accessor Methods
			...
			{
				return -util::linearToDB( targetDepth );
			}
			...
			{
				lockMutex();
				targetDepth = util::dbToLinear( -math::abs(newDepth) );
				unlockMutex();
			}
		...
		//******	Tremolo Frequency Accessor Methods
			...
			/**
			  ...
			  */
			RIM_INLINE Float getSmoothing() const
			{
				return smoothing;
			}
			...
			/**
			  ...
			  */
			RIM_INLINE void setSmoothing( Float newSmoothing )
			{
				lockMutex();
	...
	private:
		...
		//******	Private Filter Processing Methods
			...
			RIM_INLINE void modulate( const SoundBuffer& inputBuffer, SoundBuffer& outputBuffer, Size numSamples,
...
#endif // INCLUDE_RIM_SOUND_TREMOLO_H
