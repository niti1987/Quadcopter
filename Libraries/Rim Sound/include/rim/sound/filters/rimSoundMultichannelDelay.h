...
#ifndef INCLUDE_RIM_SOUND_MULTICHANNEL_DELAY_H
#define INCLUDE_RIM_SOUND_MULTICHANNEL_DELAY_H
...
class MultichannelDelay : public SoundFilter
{
	public:
		...
		//******	Delay Effect Type Accessor Methods
			...
			RIM_INLINE DelayType getType() const
			{
				return type;
			}
			...
			RIM_INLINE void setType( DelayType newType )
			{
				lockMutex();
				type = newType;
				unlockMutex();
		...
		//******	Delay Time Accessor Methods
			...
			RIM_INLINE Float getDelayTime( Index channelIndex ) const
			{
		...
		//******	Decay Time Accessor Methods
			...
			/**
			  ...
			  */
			RIM_INLINE Float getDecayTime( Index channelIndex ) const
			{
				if ( channelIndex < channels.getSize() )
		...
		//******	Feedback Gain Accessor Methods
			...
			/**
			  ...
			  * filter stability.
			  */
			RIM_INLINE Gain getFeedbackGain( Index channelIndex ) const
			{
				if ( channelIndex < channels.getSize() )
			...
			/**
			  * This value represents the gain applied to the output delay sample which is sent
			  * back to the delay buffer during each pass over the delay buffer.
			  * This value should be between -infinity and -0.00001 in order to ensure
			  * filter stability.
			  */
			RIM_INLINE Gain getFeedbackGainDB( Index channelIndex ) const
			{
				return util::linearToDB( this->getFeedbackGain( channelIndex ) );
			}
			...
			/**
			  ...
			  * filter stability.
			  */
			RIM_INLINE void setFeedbackGainDB( Index channelIndex, Gain newFeedbackGain )
			{
				this->setFeedbackGain( channelIndex, util::dbToLinear( newFeedbackGain ) );
			}
			...
			/**
			  ...
			  * filter stability.
			  */
			RIM_INLINE void setFeedbackGainDB( Gain newFeedbackGain )
			{
				this->setFeedbackGain( util::dbToLinear( newFeedbackGain ) );
			}
		...
		//******	Delay Gain Accessor Methods
			...
			/**
			  ...
			  */
			RIM_INLINE Gain getDelayGain() const
			{
				return delayGain;
			}
			...
			/**
			  ...
			  * signal before it is mixed with input signal.
			  */
			RIM_INLINE Gain getDelayGainDB() const
			{
				return util::linearToDB( delayGain );
			}
			...
			/**
			  ...
			  * signal before it is mixed with input signal.
			  */
			RIM_INLINE void setDelayGain( Gain newDelayGain )
			{
				lockMutex();
			...
			/**
			  ...
			  * signal before it is mixed with input signal.
			  */
			RIM_INLINE void setDelayGainDB( Gain newDelayGain )
			{
				lockMutex();
				targetDelayGain = util::dbToLinear( newDelayGain );
				unlockMutex();
			}
		...
		//******	Input Gain Accessor Methods
			...
			/**
			  ...
			  */
			RIM_INLINE Gain getDryGain() const
			{
				return dryGain;
			}
			...
			/**
			  ...
			  * signal before it is mixed with delayed signal.
			  */
			RIM_INLINE Gain getDryGainDB() const
			{
				return util::linearToDB( dryGain );
			}
			...
			/**
			  ...
			  * signal before it is mixed with delayed signal.
			  */
			RIM_INLINE void setDryGain( Gain newDryGain )
			{
				lockMutex();
			...
			/**
			  ...
			  * signal before it is mixed with delayed signal.
			  */
			RIM_INLINE void setDryGainDB( Gain newDryGain )
			{
				lockMutex();
				targetDryGain = util::dbToLinear( newDryGain );
				unlockMutex();
			}
		...
		//******	Filter Attribute Accessor Methods
			...
			/**
			  * This method returns the value SoundFilterCategory::DELAY.
			  */
	...
	private:
		...
		//******	Comb Filter Channel Data Class Declaration
			...
			/// A class which holds channel-dependent delay filter data for a single channel.
			class Channel
			{
				public:
		...
		//******	Private Filter Processing Methods
			...
			RIM_FORCE_INLINE static void processCombFilterNoChanges( const Sample32f* input, Sample32f* output, Size numSamples,
			...
			RIM_FORCE_INLINE static void processCombFilterChanges( const Sample32f* input, Sample32f* output, Size numSamples,
														Sample32f* const delayBufferStart, Sample32f* const delayBufferEnd,
														const Sample32f* delayRead, Sample32f* delayWrite,
			...
			RIM_FORCE_INLINE static void processAllPassFilterNoChanges( const Sample32f* input, Sample32f* output, Size numSamples,
															Sample32f* const delayBufferStart, Sample32f* const delayBufferEnd,
															const Sample32f* delayRead, Sample32f* delayWrite,
															Gain feedbackGain, Gain delayGain, Gain dryGain );
			...
			RIM_FORCE_INLINE static void processAllPassFilterChanges( const Sample32f* input, Sample32f* output, Size numSamples,
															Sample32f* const delayBufferStart, Sample32f* const delayBufferEnd,
															const Sample32f* delayRead, Sample32f* delayWrite,
															Gain feedbackGain, Gain feedbackGainChangePerSample,
															Gain delayGain, Gain delayGainChangePerSample,
...
#endif // INCLUDE_RIM_SOUND_MULTICHANNEL_DELAY_H
