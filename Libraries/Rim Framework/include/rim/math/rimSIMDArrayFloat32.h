 ...
 * 
 * File:        rim/math/SIMDArrayFloat32.h
 * 
 * Version:     1.0.0
 * 
...
#ifndef INCLUDE_RIM_SIMD_ARRAY_FLOAT_32_H
#define INCLUDE_RIM_SIMD_ARRAY_FLOAT_32_H
...
class RIM_ALIGN(16) SIMDArray<Float32,width>
{
	public:
		...
		//******	Required Alignment Accessor Methods
			...
			{
				return SIMDBaseType::getRequiredAlignment();
			}
	...
	private:
		...
		//******	Private Static Data Members
			...
			static const Size SIMD_WIDTH = SIMDType<Float32>::MAX_WIDTH;
...
#endif // INCLUDE_RIM_SIMD_ARRAY_FLOAT_32_H
