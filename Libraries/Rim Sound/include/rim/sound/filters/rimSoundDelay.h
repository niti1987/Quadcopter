 ...
 *  Rim Sound
 *
 *  Created by Carl Schissler on 7/27/12.
 *  Copyright 2012 __MyCompanyName__. All rights reserved.
 *
 */

#ifndef INCLUDE_RIM_SOUND_DELAY_H
#define INCLUDE_RIM_SOUND_DELAY_H
...
class Delay : public SoundFilter
{
	public:
		...
		//******	Delay Time Accessor Methods
			...
			RIM_INLINE Float getDelayTime() const
			{
			...
			RIM_INLINE void setDelayTime( Float newDelayTime )
			{
				lockMutex();
		...
		//******	Decay Time Accessor Methods
			...
			/**
			  ...
			  */
			RIM_INLINE Float getDecayTime() const
			{
			...
			/**
			  ...
			  */
			RIM_INLINE void setDecayTime( Float newDecayTime )
			{
				lockMutex();
		...
		//******	Feedback Gain Accessor Methods
			...
			/**
			  ...
			  * filter stability.
			  */
			RIM_INLINE Gain getFeedbackGain() const
			{
			...
			/**
			  ...
			  * filter stability.
			  */
			RIM_INLINE Gain getFeedbackGainDB() const
			{
				return util::linearToDB( targetFeedbackGain );
			}
			...
			/**
			  ...
			  * filter stability.
			  */
			RIM_INLINE void setFeedbackGain( Gain newFeedbackGain )
			{
				lockMutex();
		...
		//******	Delay Gain Accessor Methods
			...
			{
				return util::linearToDB( targetDelayGain );
			}
		...
		//******	Input Gain Accessor Methods
			...
			{
				return util::linearToDB( targetDryGain );
			}
		...
		//******	Delay Frozen Accessor Methods
			...
			/**
			  ...
			  */
			RIM_INLINE Bool getDelayIsFrozen() const
			{
				return delayFrozen;
			}
			...
			/**
			  ...
			  * same delay buffer over and over.
			  */
			RIM_INLINE void setDelayIsFrozen( Bool newDelayIsFrozen )
			{
				lockMutex();
		...
		//******	High Pass Filter Attribute Accessor Methods
			...
			RIM_INLINE void setHighPassIsEnabled( Bool newHighPassIsEnabled )
			{
				lockMutex();
			...
			/**
			  ...
			  */
			RIM_INLINE void setHighPassFrequency( Float newHighPassFrequency )
			{
				lockMutex();
			...
			/**
			  ...
			  */
			RIM_INLINE void setHighPassOrder( Size newHighPassOrder )
			{
				lockMutex();
	...
	private:
		...
		//******	Private Filter Processing Methods
			...
			RIM_FORCE_INLINE static void processDelayChanges( const SoundBuffer& inputBuffer, SoundBuffer& outputBuffer, Size numSamples,
...
#endif // INCLUDE_RIM_SOUND_DELAY_H
