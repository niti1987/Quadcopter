...
#ifndef INCLUDE_RIM_SOUND_STREAM_PLAYER_H
#define INCLUDE_RIM_SOUND_STREAM_PLAYER_H
	...
	public:
		...
		//******	Constructors
			...
			/**
			  ...
			  * within the stream.
			  */
			StreamPlayer( const Pointer<SoundInputStream>& newStream );
		...
		//******	Stream Accessor Methods
			...
			/// Return a const pointer to the SoundInputStream which is being used as a sound source.
			/**
			...
			/**
			  ...
			  * within the stream.
			  */
			void setStream( const Pointer<SoundInputStream>& newStream );
...
#endif // INCLUDE_RIM_SOUND_STREAM_PLAYER_H
