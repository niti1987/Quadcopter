...
#ifndef INCLUDE_RIM_IMAGES_PNG_TRANSCODER_H
#define INCLUDE_RIM_IMAGES_PNG_TRANSCODER_H
...
//********************************************************************************
//********************************************************************************
/// A class which handles encoding and decoding image data to/from the portable network graphics format (.png)
class PNGTranscoder : public ImageTranscoder
{
	public:
...
#endif // INCLUDE_RIM_IMAGES_PNG_TRANSCODER_H
