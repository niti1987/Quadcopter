...
#ifndef INCLUDE_RIM_SOUND_SHARED_BUFFER_POOL_H
#define INCLUDE_RIM_SOUND_SHARED_BUFFER_POOL_H
...
#include "rimSoundSharedSoundBuffer.h"
...
//********************************************************************************
//********************************************************************************
/// A class which provides a pool of thread-safe temporary SoundBuffer objects for efficient DSP processing.
/**
...
class SharedBufferPool
{
	public:
		...
		//******	Global Buffer Accessor Methods
			...
			RIM_INLINE static SharedSoundBuffer getGlobalBuffer()
			{
			...
			RIM_INLINE static SharedSoundBuffer getGlobalBuffer( Size numChannels, Size numSamples, SampleRate sampleRate )
			{
			...
			RIM_INLINE static void globalReset()
			{
				staticPool->reset();
			}
...
#endif // INCLUDE_RIM_SOUND_SHARED_BUFFER_POOL_H
