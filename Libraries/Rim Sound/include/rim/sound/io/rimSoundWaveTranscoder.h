...
#ifndef INCLUDE_RIM_SOUND_WAVE_TRANSCODER_H
#define INCLUDE_RIM_SOUND_WAVE_TRANSCODER_H
...
class WaveTranscoder : public SoundTranscoder
{
	public:
...
#endif // INCLUDE_RIM_SOUND_WAVE_TRANSCODER_H
