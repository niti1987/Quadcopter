...
#ifndef INCLUDE_RIM_SOUND_FILTER_PARAMETER_VALUE_H
...
//********************************************************************************
//********************************************************************************
/// A class which holds a union of data representing a filter parameter value.
/**
  * This class is essentially just a wrapper around a union value which
  * contains accessor methods and conversion methods for all necessary types.
  * 
...
class FilterParameterValue
{
	public:
		...
		//******	Constructors
			...
			RIM_INLINE FilterParameterValue()
			{
			}
			...
			RIM_INLINE FilterParameterValue( Bool newBoolean )
			...
			/**
			  ...
			  * types.
			  */
			RIM_INLINE FilterParameterValue( Int64 newInteger )
			...
			RIM_INLINE FilterParameterValue( Float32 newFloat )
				:	floatValue( newFloat )
			{
			}
			...
			RIM_INLINE FilterParameterValue( Float64 newDouble )
		...
		//******	Value Read Methods
			...
			/**
			  ...
			  */
			RIM_INLINE Bool getValueAsType( FilterParameterType type, Bool& output ) const
			{
				switch ( type )
				{
			...
			/**
			  ...
			  * FALSE is returned and no output is converted.
			  */
			RIM_INLINE Bool getValueAsType( FilterParameterType type, Int64& output ) const
			{
				switch ( type )
				{
					case FilterParameterType::BOOLEAN:
			...
			/**
			  ...
			  * FALSE is returned and no output is converted.
			  */
			RIM_INLINE Bool getValueAsType( FilterParameterType type, Float32& output ) const
			{
				switch ( type )
				{
					case FilterParameterType::BOOLEAN:
			...
			/**
			  ...
			  * FALSE is returned and no output is converted.
			  */
			RIM_INLINE Bool getValueAsType( FilterParameterType type, Float64& output ) const
			{
				switch ( type )
				{
					case FilterParameterType::BOOLEAN:
		...
		//******	Value Write Methods
			...
			/**
			  ...
			  * FALSE is returned and no output is converted.
			  */
			RIM_INLINE Bool setValueAsType( FilterParameterType type, Bool newValue )
			{
				switch ( type )
				{
					case FilterParameterType::BOOLEAN:
			...
			/**
			  ...
			  * FALSE is returned and no output is converted.
			  */
			RIM_INLINE Bool setValueAsType( FilterParameterType type, Int64 newValue )
			{
				switch ( type )
				{
					case FilterParameterType::BOOLEAN:
			...
			/**
			  ...
			  * FALSE is returned and no output is converted.
			  */
			RIM_INLINE Bool setValueAsType( FilterParameterType type, Float32 newValue )
			{
				switch ( type )
				{
					case FilterParameterType::BOOLEAN:
			...
			/**
			  ...
			  * FALSE is returned and no output is converted.
			  */
			RIM_INLINE Bool setValueAsType( FilterParameterType type, Float64 newValue )
			{
				switch ( type )
				{
					case FilterParameterType::BOOLEAN:
...
#endif // INCLUDE_RIM_SOUND_FILTER_PARAMETER_VALUE_H
