...
#ifndef INCLUDE_RIM_BASIC_THREAD_H
#define INCLUDE_RIM_BASIC_THREAD_H
...
class BasicThread
{
	public:
		...
		//******	Constructor
			...
			/// Create a default thread which is not yet running.
			BasicThread();
			...
			/**
			  ...
			  * the copied object.
			  */
			BasicThread( const BasicThread& other );
		...
		//******	Assignment Operator
			...
			/**
			  ...
			  */
			BasicThread& operator = ( const BasicThread& other );
	...
	protected:
		...
		//******	Protected Virtual Run Function
			...
			/**
			  * This virtual method is called by the BasicThread class when a new thread
	...
	private:
		...
		//******	Private Class Declaration
			...
			/// A class which holds platform-specific data for this thread object.
			class ThreadWrapper;
		...
		//******	Private Data Members
			...
			/// A class which wraps platform-specific thread functionality.
...
#endif // INCLUDE_RIM_BASIC_THREAD_H
