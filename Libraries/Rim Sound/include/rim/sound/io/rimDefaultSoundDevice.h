/*
 *  rimDefaultSoundDevice.h
 *  Rim Sound
 *
 *  Created by Carl Schissler on 7/25/12.
 *  Copyright 2012 __MyCompanyName__. All rights reserved.
 *
 */

#ifndef INCLUDE_RIM_DEFAULT_SOUND_DEVICE_H
#define INCLUDE_RIM_DEFAULT_SOUND_DEVICE_H
...
#include "rimSoundDeviceManager.h"
#include "rimSoundDevice.h"
...
//********************************************************************************
//********************************************************************************
/// A class which maintains a default input and output device abstraction layer.
/**
...
class DefaultSoundDevice
{
	public:
		...
		//******	Device Status Accessor Method
			...
			/**
			  ...
			  */
			RIM_INLINE Bool isDefaultInput() const
			{
				return this->isInput();
			}
			...
			/**
			  ...
			  */
			RIM_INLINE Bool isDefaultOutput() const
			{
	...
	private:
		...
		//******	Private Data Members
			...
			/// An object which manages the list of devices.
			...
			/// A delegate object which responds to events for this sound device.
...
#endif // INCLUDE_RIM_DEFAULT_SOUND_DEVICE_H
