/*
 *  rimSoundMIDIDeviceManagerDelegate.h
 *  Rim Sound
 *
...
#ifndef INCLUDE_RIM_MIDI_DEVICE_MANAGER_DELEGATE_H
#define INCLUDE_RIM_MIDI_DEVICE_MANAGER_DELEGATE_H
...
//********************************************************************************
//********************************************************************************
/// A class which contains function objects that recieve MIDIDeviceManager events.
/**
...
class MIDIDeviceManagerDelegate
{
	public:
		...
		//********************************************************************************
		//********************************************************************************
		//******	MIDI Device Manager Delegate Callback Functions
			
			
			
			
			/// A function object which is called whenever a new MIDI device is discovered by the system.
			/**
			  * This callback is called whenever a new MIDI device is connected or added to the
			  * system. This allows the user to use new MIDI devices as they are discovered.
			  *
			...
			/// A function object which is called whenever a MIDI device is removed from the system.
			/**
			  * This callback is called whenever a MIDI device is disconnected or removed from the
...
#endif // INCLUDE_RIM_MIDI_DEVICE_MANAGER_DELEGATE_H
