 ...
 *  Rim IO
 *
 *  Created by Carl Schissler on 3/21/08.
 *  Copyright 2008 __MyCompanyName__. All rights reserved.
 *
 */

#ifndef INCLUDE_RIM_FILE_WRITER_H
#define INCLUDE_RIM_FILE_WRITER_H
...
class FileWriter : public DataOutputStream, public StringOutputStream
{
	public:
		...
		//******	Constructors
			...
			/// Create a FileWriter object which should write to the file at the specified path string.
			...
			/// Create a FileWriter object which should write to the file at the specified path.
			FileWriter( const fs::Path& filePath );
			
			
			
			
			/// Create a FileWriter object which should write to the specified file.
		...
		//******	File Attribute Accessor Methods
			...
			/** 
			  ...
			  */
			RIM_INLINE const fs::File& getFile() const
			{
				return file;
			}
			...
			/** 
			  ...
			  */
			RIM_INLINE const fs::Path& getFilePath() const
			{
				return file.getPath();
			}
			...
			/** 
			  ...
			  */
			RIM_INLINE LargeSize getFileSize() const
			{
				return file.getSize();
			}
			...
			/** 
			  ...
			  * path queried by getFilePath() exists. It then returns TRUE
			  ...
			  */
			RIM_INLINE Bool fileExists() const
			{
				return file.exists();
			}
		...
		//******	File Writer Open/Close Methods
			...
			/**
			  ...
			  * the writer is closed. If the file is unable to be closed, an IOException is
			  * thrown. If the file writer is already closed when the method is called,
		...
		//******	Seek/Move Methods
			...
			/**
			  * If the file which is being written is open and valid, this
...
#endif // INCLUDE_RIM_FILE_WRITER_H
