	...
	public:
		...
		//******	Constructors
			...
			/**
			  ...
			  */
			OggEncoder( const UTF8String& newFilePath, Size numChannels, SampleRate newSampleRate,
						Float kbitRate = Float(192), Bool isVBR = true );
			...
			/**
			  ...
			  * sample rate converting any audio that doesn't match the output sample rate.
			  */
			OggEncoder( const File& newFile, Size numChannels, SampleRate newSampleRate,
						Float kbitRate = Float(192), Bool isVBR = true );
			...
			/**
			  ...
			  * sample rate converting any audio that doesn't match the output sample rate.
			  */
			OggEncoder( const Pointer<DataOutputStream>& outputStream, Size numChannels, SampleRate newSampleRate,
						Float kbitRate = Float(192), Bool isVBR = true );
