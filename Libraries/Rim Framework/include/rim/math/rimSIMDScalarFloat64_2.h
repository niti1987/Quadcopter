...
#ifndef INCLUDE_RIM_SIMD_SCALAR_FLOAT_64_2_H
#define INCLUDE_RIM_SIMD_SCALAR_FLOAT_64_2_H
...
class RIM_ALIGN(16) SIMDScalar<Float64,2>
{
	...
	public:
		...
		//******	Load Methods
			...
			RIM_FORCE_INLINE static SIMDScalar load( const Float64* array )
			{
#if RIM_USE_SIMD && defined(RIM_SIMD_SSE) && RIM_SSE_VERSION_IS_SUPPORTED(2,0)
			...
			RIM_FORCE_INLINE static SIMDScalar loadUnaligned( const Float64* array )
			{
#if RIM_USE_SIMD && defined(RIM_SIMD_SSE) && RIM_SSE_VERSION_IS_SUPPORTED(2,0)
		...
		//******	Store Method
			...
			RIM_FORCE_INLINE void storeUnaligned( Float64* destination ) const
			{
#if RIM_USE_SIMD && defined(RIM_SIMD_SSE) && RIM_SSE_VERSION_IS_SUPPORTED(2,0)
		...
		//******	Comparison Operators
			...
			/**
			  ...
			  */
			RIM_FORCE_INLINE SIMDScalar<Int64,2> operator == ( const SIMDScalar& scalar ) const
			{
#if RIM_USE_SIMD && defined(RIM_SIMD_SSE) && RIM_SSE_VERSION_IS_SUPPORTED(2,0)
				return SIMDScalar<Int64,2>( _mm_cmpeq_pd( v, scalar.v ) );
#else
			...
			/**
			  ...
			  * component is non-zero. Otherwise, that result component is equal to zero.
			  */
			RIM_FORCE_INLINE SIMDScalar<Int64,2> operator == ( const Float64 value ) const
			{
#if RIM_USE_SIMD && defined(RIM_SIMD_SSE) && RIM_SSE_VERSION_IS_SUPPORTED(2,0)
				return SIMDScalar<Int64,2>( _mm_cmpeq_pd( v, _mm_set1_pd( value ) ) );
#else
			...
			{
#if RIM_USE_SIMD && defined(RIM_SIMD_SSE) && RIM_SSE_VERSION_IS_SUPPORTED(2,0)
				return SIMDScalar<Int64,2>( _mm_cmpneq_pd( v, scalar.v ) );
#else
				return SIMDScalar<Int64,2>( a != scalar.a, b != scalar.b );
#endif
			}
			...
			{
#if RIM_USE_SIMD && defined(RIM_SIMD_SSE) && RIM_SSE_VERSION_IS_SUPPORTED(2,0)
				return SIMDScalar<Int64,2>( _mm_cmpneq_pd( v, _mm_set1_pd( value ) ) );
#else
				return SIMDScalar<Int64,2>( a != value, b != value );
#endif
			}
			...
			{
#if RIM_USE_SIMD && defined(RIM_SIMD_SSE) && RIM_SSE_VERSION_IS_SUPPORTED(2,0)
				return SIMDScalar<Int64,2>( _mm_cmplt_pd( v, scalar.v ) );
#else
				return SIMDScalar<Int64,2>( a < scalar.a, b < scalar.b );
#endif
			}
			...
			{
#if RIM_USE_SIMD && defined(RIM_SIMD_SSE) && RIM_SSE_VERSION_IS_SUPPORTED(2,0)
				return SIMDScalar<Int64,2>( _mm_cmplt_pd( v, _mm_set1_pd( value ) ) );
#else
				return SIMDScalar<Int64,2>( a < value, b < value );
#endif
			}
			...
			{
#if RIM_USE_SIMD && defined(RIM_SIMD_SSE) && RIM_SSE_VERSION_IS_SUPPORTED(2,0)
				return SIMDScalar<Int64,2>( _mm_cmpgt_pd( v, scalar.v ) );
#else
				return SIMDScalar<Int64,2>( a > scalar.a, b > scalar.b );
#endif
			}
			...
			{
#if RIM_USE_SIMD && defined(RIM_SIMD_SSE) && RIM_SSE_VERSION_IS_SUPPORTED(2,0)
				return SIMDScalar<Int64,2>( _mm_cmpgt_pd( v, _mm_set1_pd( value ) ) );
#else
				return SIMDScalar<Int64,2>( a > value, b > value );
#endif
			}
			...
			{
#if RIM_USE_SIMD && defined(RIM_SIMD_SSE) && RIM_SSE_VERSION_IS_SUPPORTED(2,0)
				return SIMDScalar<Int64,2>( _mm_cmple_pd( v, scalar.v ) );
#else
				return SIMDScalar<Int64,2>( a <= scalar.a, b <= scalar.b );
#endif
			}
			...
			{
#if RIM_USE_SIMD && defined(RIM_SIMD_SSE) && RIM_SSE_VERSION_IS_SUPPORTED(2,0)
				return SIMDScalar<Int64,2>( _mm_cmple_pd( v, _mm_set1_pd( value ) ) );
#else
				return SIMDScalar<Int64,2>( a <= value, b <= value );
#endif
			}
			...
			{
#if RIM_USE_SIMD && defined(RIM_SIMD_SSE) && RIM_SSE_VERSION_IS_SUPPORTED(2,0)
				return SIMDScalar<Int64,2>( _mm_cmpge_pd( v, scalar.v ) );
#else
				return SIMDScalar<Int64,2>( a >= scalar.a, b >= scalar.b );
#endif
			}
			...
			{
#if RIM_USE_SIMD && defined(RIM_SIMD_SSE) && RIM_SSE_VERSION_IS_SUPPORTED(2,0)
				return SIMDScalar<Int64,2>( _mm_cmpge_pd( v, _mm_set1_pd( value ) ) );
#else
				return SIMDScalar<Int64,2>( a >= value, b >= value );
#endif
			}
	...
	private:
		...
		//******	Private Friend Declarations
			...
			friend RIM_FORCE_INLINE SIMDScalar select( const SIMDScalar<Int64,2>& selector,
...
{
#if RIM_USE_SIMD && defined(RIM_SIMD_SSE) && RIM_SSE_VERSION_IS_SUPPORTED(1,0)
	return SIMDScalar<Float64,2>( _mm_shuffle_pd( scalar1.v, scalar2.v, _MM_SHUFFLE2(i2, i1) ) );
#else
...
RIM_FORCE_INLINE SIMDScalar<Float64,2> select( const SIMDScalar<Int64,2>& selector,
...
#endif // INCLUDE_RIM_SIMD_SCALAR_FLOAT_64_2_H
