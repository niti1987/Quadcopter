...
#ifndef INCLUDE_RIM_SOUND_LIMITER_H
#define INCLUDE_RIM_SOUND_LIMITER_H
...
//********************************************************************************
//********************************************************************************
/// A class which keeps sound from ever going above a limiting threshold.
	...
	public:
		...
		//******	Channel Link Status Accessor Methods
			...
			/**
			  ...
			  * a slow attack.
			  */
			RIM_INLINE Bool getSaturationIsEnabled() const
			{
			...
			/**
			  ...
			  * a slow attack.
			  */
			RIM_INLINE void setSaturationIsEnabled( Bool newSaturationIsEnabled )
			{
				lockMutex();
		...
		//******	Saturation Knee Accessor Methods
			...
			/**
			  ...
			  * output clipping.
			  */
			RIM_INLINE Gain getSaturationKnee() const
			{
			...
			/**
			  ...
			  */
			RIM_INLINE void setSaturationKnee( Gain newSaturationKnee )
			{
				lockMutex();
	...
	private:
		...
		//******	Private Filter Processing Methods
			...
			/**
			  ...
			  */
			RIM_INLINE void limitNoChanges( const SoundBuffer& inputBuffer, SoundBuffer& outputBuffer, Size numSamples,
			...
			/**
			  ...
			  * and thus we can save time by not having to interpolate the parameters.
			  */
			RIM_INLINE void limit( const SoundBuffer& inputBuffer, SoundBuffer& outputBuffer, Size numSamples,
									Gain envelopeAttack, Gain envelopeRelease,
			...
			RIM_FORCE_INLINE static Gain getDBReduction( Float level, Gain threshold,
...
#endif // INCLUDE_RIM_SOUND_LIMITER_H
